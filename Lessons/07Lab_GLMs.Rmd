...
```{r}
#Exercise 1: geom_density of ozone divided by year
density <-
...
#Exercise 1: geom_boxplot of ozone divided by year
boxplot <-
...
#Exercise 1: geom_violin of ozone divided by year
```
...
PM2.5byAll <- lm(data = EPAair.subset, PM2.5 ~Ozone + Year + Month + mean_Lat + mean_Lng)
...
PM2.5byBest <- lm(data = EPAair.subset)
